...
def quadratic_expression(function):
    # Pattern should be in the form:
    # 1) ax**2+bx+c
    # 2) ax^2+bx+c
    # If a, b, or c is 1, it should be stated!
...
def roots(a, b, c):
    if discriminant(a, b, c) < 0:
        ...
        x_one = ((-b + math.sqrt(discriminant(a, b, c))) / (2 * a))
        x_two = ((-b - math.sqrt(discriminant(a, b, c))) / (2 * a))
        return x_one, x_two
